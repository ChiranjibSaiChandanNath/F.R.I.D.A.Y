"""
F.R.I.D.A.Y. Memory & Planning — persistent context, tasks, notes, and smart routing.

Three systems:
1. Memory — facts, preferences, project context F.R.I.D.A.Y. learns from conversations
...
so F.R.I.D.A.Y. gets smarter over time.
"""
...
DB_PATH = Path(__file__).parent / "data" / "friday.db"
...
# ---------------------------------------------------------------------------
# Memories — facts F.R.I.D.A.Y. learns
# ---------------------------------------------------------------------------
...
async def extract_memories(user_text: str, friday_response: str, anthropic_client) -> list[str]:
    ...
    try:
        response = await anthropic_client.messages.create(
            ...
            system=(
                ...
                "Do NOT extract facts about F.R.I.D.A.Y. not knowing something, fallback responses, or user name/information being unknown. "

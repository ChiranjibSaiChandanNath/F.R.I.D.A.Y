"""
FRIDAY Browser — Playwright-based web browsing capabilities.
...
log = logging.getLogger("friday.browser")
...
class FridayBrowser:
    """Playwright-based web browsing for F.R.I.D.A.Y."""
    ...
    async def _ensure_browser(self):
        ...
        # Launch VISIBLE browser so user can watch F.R.I.D.A.Y. browse
    ...
    async def screenshot(self, url: str, path: str = None) -> str:
        ...
        try:
            ...
            if not path:
                tmp = tempfile.mktemp(suffix=".png", prefix="friday_screenshot_")
                path = tmp

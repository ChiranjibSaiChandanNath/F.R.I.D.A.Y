"""
F.R.I.D.A.Y. Proactive Suggestions — Contextual follow-up suggestions after task completion.
...
log = logging.getLogger("friday.suggestions")
...
class Suggestion:
    ...
    text: str  # Voice-friendly suggestion (F.R.I.D.A.Y. personality)

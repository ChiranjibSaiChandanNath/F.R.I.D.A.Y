"""
F.R.I.D.A.Y. Template Evolution — Analyzes failures and generates improved template versions.
...
log = logging.getLogger("friday.evolution")

TEMPLATES_DIR = Path(__file__).parent / "templates" / "prompts"
DB_PATH = Path(__file__).parent / "friday_data.db"

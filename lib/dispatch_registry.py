"""
F.R.I.D.A.Y. Dispatch Registry — tracks all active and recent project builds/dispatches.

Persists to SQLite so F.R.I.D.A.Y. always knows what he's working on,
...
log = logging.getLogger("friday.dispatch")

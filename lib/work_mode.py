"""
F.R.I.D.A.Y. Work Mode — persistent claude -p sessions tied to projects.

F.R.I.D.A.Y. can connect to any project directory and maintain a conversation
...
F.R.I.D.A.Y. reads the responses via subprocess, summarizes, and reports back.
"""
...
log = logging.getLogger("friday.work_mode")
...
class WorkSession:
    ...
    Each project gets its own session. F.R.I.D.A.Y. can switch between projects

/**
 * F.R.I.D.A.Y. — Multi-mode particle visualization.
 *
...
export function createOrb(canvas: HTMLCanvasElement): Orb {
  ...
  const mat = new THREE.PointsMaterial({
    color: 0x9c4ce8, size: 0.4, transparent: true, opacity: 0.6,
  ...
  const lineMat = new THREE.LineBasicMaterial({
    color: 0x9c4ce8, transparent: true, opacity: 0.0,
  ...
  function animate() {
    ...
    switch (state) {
      case "sleeping":
        targetRadius = 28; targetSpeed = 0.05; targetBright = 0.3; targetSize = 0.3;
    ...
    if (state === "sleeping") { mat.color.lerp(new THREE.Color(0x321a5c), 0.015); lineMat.color.lerp(new THREE.Color(0x321a5c), 0.015); }
    else if (state === "thinking") { mat.color.lerp(new THREE.Color(0xff6ec4), 0.015); lineMat.color.lerp(new THREE.Color(0xff6ec4), 0.015); }
    else if (state === "speaking") { mat.color.lerp(new THREE.Color(0xb85af0), 0.015); lineMat.color.lerp(new THREE.Color(0xb85af0), 0.015); }
    else { mat.color.lerp(new THREE.Color(0x9c4ce8), 0.015); lineMat.color.lerp(new THREE.Color(0x9c4ce8), 0.015); }
